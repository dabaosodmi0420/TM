...
typedef NS_ENUM(NSUInteger, SMPageControlCurrentIndicatorType) {
    SMPageControlCurrentIndicatorTypeEqual = 1,
    SMPageControlCurrentIndicatorTypeGreater
};

@interface YT_PageControl : UIControl

@property (nonatomic) NSInteger numberOfPages;
@property (nonatomic) NSInteger currentPage;
@property (nonatomic) CGFloat indicatorW ;//SMPageControlCurrentIndicatorTypeGreater下选中的宽度
...
@property (nonatomic) SMPageControlCurrentIndicatorType indicatorType   UI_APPEARANCE_SELECTOR;    // deafult is Middle
...
- (void)updatePageNumberForScrollView:(UIScrollView *)scrollView;@end
